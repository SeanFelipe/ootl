...
'''
screen.blit(pacmanl, (170, ghosty))
screen.blit(pacmanu, (270, ghosty))
screen.blit(pacmand, (370, ghosty))

ghost2y = 200
screen.blit(pacman2r, (70, ghost2y))
screen.blit(pacman2l, (170, ghost2y))
screen.blit(pacman2u, (270, ghost2y))
screen.blit(pacman2d, (370, ghost2y))
'''
